              ...
              <Row>
                <Col className="innerMainSection" xl={7} lg={7} md={7} sm={7} xs={7}>
                  <Container fluid="true">
                    ...
                    <LineItemsContainer line_items={line_items} user={user} budget_members={budget_members} handleFormSubmit={this.handleNewLineItemFormSubmit} budget_id={this.state.budget.id} />
                  </Container>
                </Col>
