          ...
          <Container fluid="true" className="noGutters">
            <Row>
              ...
              <Col xl={7} lg={7} md={12} sm={12} xs={12}>
                <input type="email" name="email" placeholder="Enter Email" defaultValue="andrea@email.com" />
              </Col>
            </Row>
            <Row>
              <Col xl={5} lg={5} md={12} sm={12} xs={12}>
              ...
              <Col xl={7} lg={7} md={12} sm={12} xs={12}>
                <input type="password" name="password" placeholder="Enter Password" defaultValue="12345" />
              </Col>
            </Row>
            <Row>
